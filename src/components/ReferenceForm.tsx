...
interface ReferenceFormProps {
  ...
  onSave: (reference: Omit<Reference, "id" | "createdAt" | "lastOpenedAt">) => void;
  onCancel: () => void;
...
export function ReferenceForm({
  ...
  const handleSubmit = useCallback(
    (e: React.FormEvent) => {
      ...
      const reference: Omit<Reference, "id" | "createdAt" | "lastOpenedAt"> = {
    ...
    <form onSubmit={handleSubmit} className="reference-form">
      ...
      <div className="form-field">
        ...
        {validationErrors.referenceName && (
          <span className="field-error">{validationErrors.referenceName}</span>
        )}
      </div>
      ...
      <div className="form-field">
        ...
        {validationErrors.absolutePath && (
          <span className="field-error">{validationErrors.absolutePath}</span>
        )}
      </div>
      ...
      <div className="form-actions">
        ...
        <button type="submit" className="btn-primary" disabled={isSubmitting}>
          {isSubmitting ? "Saving..." : mode === "add" ? "Add Reference" : "Save Changes"}
        </button>
      </div>
    </form>
  );
